...
import {getConsultants, getLecturers, getThemes, postTheme} from "../shared/services/axios.service.ts";
...
export function CreateThemePage() {
    ...
    useEffect(() => {
        getThemes().then(response => {
            ...
            setSources(Array.from(new Set(themes.map((t) => t.suggestedby))));
        });
                                ...
                                <FormControl fullWidth>
                                    ...
                                    >
                                        {lecturers?.map((lecturer, i) => (
                                            <MenuItem key={i} value={lecturer.id}>{lecturer.id}</MenuItem>
                                        ))}
                                    </Select>
                                </FormControl>
                            </Grid>

...
export function StaffThemeSelection({ practiceId }: { practiceId?: number }) {
    ...
    useEffect(() => {
        ...
        if (practiceId) {
            getPractice(practiceId).then((response) => {
                ...
                setConsultantId(selectedPractice?.consultant?.id ?? null);
                setSelectedGrade(selectedPractice?.finalgrade ?? null);
            });
        }
    }, [practiceId]);
    ...
    return (
        <Grid container spacing={3}>
                ...
                {practice?.finalgrade && (
                    <Box sx={{ mb: 3, p: 2, borderRadius: 1 }}>
                        ...
                        <Typography variant="body2">
                            Научный руководитель или руководитель практики пометил эту работу
                            как завершенную
                        </Typography>
                    </Box>
                )}
                    ...
                    <CardContent sx={{ py: 1 }}>
                        ...
                        <Typography paragraph sx={{ mb: 0 }}>
                            ...
                            <b>
                                ...
                                {practice?.supervisor?.middleName}
                            </b>
                            <br />
                            ...
                            {practice?.consultant == null ? (
                                <Button
                                    size="small"
                                    onClick={() => setShowConsultantInput(true)}
                                ...
                                <>
                                    Консультант:{" "}
                                    <b>
                                        {practice?.consultant?.lastName}{" "}
                                        {practice?.consultant?.firstName}{" "}
                                        {practice?.consultant?.middleName}
                                    </b>
                                    <br />
                            ...
                            <Box sx={{ mt: 2 }}>
                                ...
                                <Box display="flex" justifyContent="space-between" sx={{ mt: 1 }}>
                                    ...
                                    <Button
                                        ...
                                        color="error"
                                        size="small"
                                        onClick={() => setShowConsultantInput(false)}
                                    >
                                        Отмена
                                    </Button>
                                </Box>
                        ...
                        <Box display="flex" justifyContent="space-between" sx={{ mt: 3 }}>
                            <Button variant="contained" size="small" onClick={() => setEditModalOpen(true)}>
                                Редактировать
                            </Button>
                            <Button variant="outlined" color="error" size="small" onClick={handleRefuseTheme}>
            ...
            <Modal open={editModalOpen} onClose={() => setEditModalOpen(false)}>
                <Box sx={modalStyle}>
                    <Typography variant="h6" gutterBottom>
                        Редактировать тему и руководителя
                    </Typography>
                    ...
                    {/* Селект для оценки */}
                    <FormControl fullWidth sx={{ mt: 2 }}>
                        <InputLabel>Итоговая оценка</InputLabel>
                        <Select
                            value={selectedGrade ?? ""}
                    ...
                    <Box display="flex" justifyContent="flex-end" sx={{ mt: 3 }}>
                        <Button variant="contained" onClick={handleEditSave} sx={{ mr: 2 }}>
                            Сохранить
                        </Button>
            ...
            <Modal open={confirmModalOpen} onClose={() => setConfirmModalOpen(false)}>
                <Box sx={modalStyle}>
                    ...
                    <Typography sx={{ mb: 3 }}>
                        Вы действительно хотите отказаться от практики?
                    </Typography>
